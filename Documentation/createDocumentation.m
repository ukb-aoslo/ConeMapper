...
%
%% Links:
% https://github.com/nilsBoeAc/m2docgen
% https://nl.mathworks.com/matlabcentral/fileexchange/96289-m2docgen

%cd(fileparts(which(mfilename)));
cPath = fileparts(which(mfilename));

mF = string(fileparts(cPath));
oF = fullfile(cPath,"ConeMapperDocumentation");

opts = struct(  'toolboxName',      "Cone Mapper", ...
                'delOld',           true, ...
                'mFolder',          cPath, ...
                'outputFolder',     oF, ...
                'excludeFolder',	"ConeMapperDocumentation", ...
                'excludeFile',      "createDocumentation", ...
                'htmlMetaFolder',   "ressources", ...
                'htmlTemplate',     "m2doc-standard", ...
                'startPage',        "Welcome to Cone Mapper.html", ...
                'toc',              [], ...
                'verbose',          false);
             
opts.toc = {"Cone Mapper", "/", {...
             "Basics", ["Basics"], {};...
             "Cone recognition", ["Cone recognition"], {};...
             "Import and Export", ["Import-Export"], {};...
             "Metrics", ["Metrics"], {};...
             "Working with image", ["Working with image"], {};...
             }};
