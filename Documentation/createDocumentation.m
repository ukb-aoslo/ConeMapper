...
oF = fullfile(cPath,"ConeFinderDocumentation");

opts = struct(  'toolboxName',      "Cone Finder App", ...
                'delOld',           true, ...
                'mFolder',          cPath, ...
                'outputFolder',     oF, ...
                'excludeFolder',	"ConeFinderDocumentation", ...
                'excludeFile',      "createDocumentation", ...
                'htmlMetaFolder',   "ressources", ...
                'htmlTemplate',     "m2doc-standard", ...
                'startPage',        "Welcome to ConeFinder App.html", ...
                'toc',              [], ...
                'verbose',          false);
